...
const WBPlayer = (() => {
  ...
  // Зона намеренно широкая: на кадрах от ~500 px решает радиус в метрах, и
  // превью ведёт себя ровно как видео. Пиксельная проверка срабатывает только
  // на совсем узких кадрах, где 2.5 км уже не влезают.
  const HOLD_RADIUS_M = 2500;
  const HOLD_SAFE_FRAC = 0.8;

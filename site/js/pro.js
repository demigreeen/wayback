...
const WBPro = (() => {
  ...
  // позже. На price.html тот же список написан руками в HTML, и это
  // намеренно: смысловой текст страницы не должен появляться скриптом,
  // иначе поисковый робот увидит пустой раздел. Правки — в оба места,
  // а состав услуги ещё и в п. 1.1 оферты.
  const FEATURES = [
    'В углу кадра не будет надписи <b>wayback.pro</b>',
    'Выбор периода: видео за нужный год или свой отрезок дат',
    'Тёмная тема карты',
    'Разовый платёж, без подписки и без аккаунта',

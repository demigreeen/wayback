...
const WBLicense = (() => {
  ...
  // ---------------------------------------------------------------- настройка
  //
  // ССЫЛКА НА ОПЛАТУ. Пока строка пустая, блок покупки на сайте не
  // показывается — чтобы посетитель не упирался в нерабочую кнопку.
  // Вставьте сюда ссылку из платёжного сервиса, и блок появится сам.
  const PAY_URL = '';
